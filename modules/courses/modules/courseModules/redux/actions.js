...
// export const getModulesUnAuth = course_code => (dispatch, getState) => {
//   const {
...
//
//   const modules_link = get(course, "_links.modules");
//
// }
...
export const getModules = course_code => (dispatch, getState) => {
  ...
  if (!single_course) return console.log("course not found");
  const modules_link = get(single_course, "_links.modules");
